...
<ol>
    ...
    <li>Dizi içerisinde farklı türden birçok değer bulunabilir.(int,string,double,obje)
        ...
        <li>echo $diziAdi ile dizi içeriği ekrana yazdırılamaz. Arraay to String
             Conversion hatası verir. Fakat dizinin örneğin 3 indisine sahip elemanı 
            echo $diziAdi [3] şeklinde yazdırılabilir.</li>
